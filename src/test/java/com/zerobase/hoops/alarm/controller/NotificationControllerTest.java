...
class NotificationControllerTest {
  ...
  void notificationsTest() throws Exception {
    ...
    notificationDtos.add(
        new NotificationDto("1", "FRIEND",
            "첫번째알림", OffsetDateTime.now(ZoneOffset.ofHours(9)).plusDays(1)));
    notificationDtos.add(
        new NotificationDto("2","REPORT",
            "두번째알림", OffsetDateTime.now(ZoneOffset.ofHours(9)).plusDays(2)));
    notificationDtos.add(
        new NotificationDto("3", "REJECTED_GAME",
            "세번째알림", OffsetDateTime.now(ZoneOffset.ofHours(9)).plusDays(3)));
